            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="tel:+1-555-123-4567" className="text-white hover:text-green-400 transition-colors">
                    +1 (555) 123-4567
                  </a>
                </div>
              </div>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-400">DSS Level 1</span>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-400">2 Type II</span>
                </div>
              </div>
            </div>
