...
export default function PaymentMethodsSection() {
  ...
  return (
    <section className="py-20 lg:py-32 bg-gradient-to-br from-purple-50 via-blue-50 to-green-50 dark:bg-gray-800/50">
                ...
                <motion.button
                  ...
                  className={`w-full p-4 rounded-xl text-left transition-all duration-300 ${
                    activeMethod === method.id
                      ? 'bg-white dark:bg-gray-800 shadow-xl shadow-green-500/20 border-2 border-green-300 dark:border-green-800 scale-105'
                      : 'bg-white/70 backdrop-blur-sm dark:bg-gray-800/50 hover:bg-white hover:shadow-lg hover:shadow-blue-500/10 dark:hover:bg-gray-800 border-2 border-transparent hover:scale-102'
                  }`}
