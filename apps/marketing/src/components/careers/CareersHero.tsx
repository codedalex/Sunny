...
export function CareersHero() {
  ...
  const stats = [
    { number: '3', label: 'Founding Team', description: 'Expert leadership' },
    { number: '190+', label: 'Target Markets', description: 'Global opportunity' },
    { number: 'Remote', label: 'Work Style', description: 'Flexible culture' },
    { number: 'Pre-Launch', label: 'Stage', description: 'Ground floor opportunity' }
  ];
      ...
      <div className="container mx-auto px-6 relative">
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            >
              Join a passionate team of innovators building revolutionary payment infrastructure 
              that will connect businesses across 190+ countries. Be part of something extraordinary 
              from the ground up.
            </motion.p>
          ...
          >
            <div className="text-center p-6 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Push boundaries and create solutions that didn't exist before
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Build technology that connects and empowers businesses worldwide
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Rapid iteration and execution in a dynamic startup environment
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-2">
                Join Us at the Perfect Time
              </h2>
              <p className="text-xl opacity-90 max-w-3xl mx-auto mb-8">
                Ground floor opportunity to shape the future of payments with 
                experienced founders and cutting-edge technology.
              </p>
